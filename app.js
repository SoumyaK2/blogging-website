...
app.get("/posts/:urlElement",function(req,res){   //express routing parameters
  const requistTitle= _.lowerCase(req.params.urlElement);

  posts.forEach(function(element){
    const stroedTitle= _.lowerCase(element.title);

    if(requistTitle===stroedTitle){
